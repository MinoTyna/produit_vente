...
# ]
from django.urls import path
from .views import PaiementCreateView, PaiementListView, VerifierPaiementListView, PaiementDeleteAPIView, ListeResteAPayerParClient,ListePayerParClient,PaiementUpdateView,SmsVerifierByClientView,RepaiementCreateView,PaiementView,ChiffreAffairesAPIView
...
urlpatterns = [
    ...
    path('update/<int:pk>', PaiementUpdateView.as_view(), name='update-paiement'),
    path('get/client', ListeResteAPayerParClient.as_view(), name='delete-paiement'),
    path('get/<int:client_id>/<str:date_achat>', ListePayerParClient.as_view(), name='delete-paiement'),
